  ...
  <div class="row" id="comment${id}">
    <div class="span11 comment-wrapper">
      ...
      <div class="row like-wrapper" style="display: none;">
        {{if member.self==false}}<a><span class="like-post" data-like-id="${id}" data-like-target="e" member-id="${member.id}"><i class="icon-thumbs-up"></i>&nbsp;&nbsp;&nbsp;</span></a>{{/if}}
        <a><span class="like-cancel" data-like-id="${id}" data-like-target="e" style="display: none;">いいね！を取り消す&nbsp;</span></a>
        <a><span class="like-list" data-like-id="${id}" data-like-target="e">いいね！</span></a>
      </div>
    </div>
  </div>
</script>
